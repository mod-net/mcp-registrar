...
mod tests {
    ...
    fn test_tool_with_metadata() {
        ...
        assert_eq!(tool.metadata.get("author").unwrap(), &serde_json::json!("Test Author"));
        assert_eq!(tool.metadata.get("tags").unwrap(), &serde_json::json!(["tag1", "tag2"]));
    }
    ...
    fn test_tool_validate_parameters_with_schema() {
        ...
        assert_eq!(result.unwrap_err(), "Required parameter 'param2' is missing");
    ...
    fn test_tool_serialization() {
        ...
        assert_eq!(schema.get("required").unwrap(), &serde_json::json!(["param1"]));
    }
} 