...
pub fn module_api_addr() -> String {
    std::env::var("MODULE_API_ADDR").unwrap_or_else(|_| "127.0.0.1:8090".into())
}

pub fn module_api_max_upload_bytes() -> usize {
    let mb: usize = std::env::var("MODULE_API_MAX_UPLOAD_MB").ok()
...
pub fn chain_rpc_url() -> String {
    std::env::var("CHAIN_RPC_URL").unwrap_or_else(|_| "ws://127.0.0.1:9944".into())
}
